/*
    Author: Weibingchuan
    Comments: Odometry of a holonomic chassis is not easy, especially for sychro-drive mode, so the odometry based on encoder is 
        temporarily silenced here, only openloop pose estimation used. 
*/

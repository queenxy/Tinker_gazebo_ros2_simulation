/*
    Copied From ros2 controller doc
*/

#ifndef TINKER_CONTROLLER__SPEED_LIMITER_HPP_
#define TINKER_CONTROLLER__SPEED_LIMITER_HPP_
...
#endif  // TINKER_CONTROLLER__TINKER_CONTROLLER_HPP_